		...
		this.each(function(i) {
			...
			if (options) {
				...
				if (options.buttonText) {
					button = $("<button class='pretty-file-input'><span class=\"fa fa-file-o\"></span>" +options.buttonText+ "</button>");
				}
			}
			// If no options are set
			else {
				button = $("<button class='pretty-file-input'><span class=\"fa fa-file-o\"></span>Select a file</button>");
			}
